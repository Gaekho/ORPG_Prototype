...
public class CardList 
{
    ...
    public void LoadCards(){
        ...
        cardList.Add(new AttackCard(0, "분노", 1, "공격", 10f, () => {Debug.Log("분노 사용"); PlayerEventManager.Attack();}));
        ...
        cardList.Add(new SupportCard(6, "계몽", 1, "보조", ()=> {Debug.Log("계몽 사용"); PlayerStatus.GetEnergy(2f);}));
        //...
